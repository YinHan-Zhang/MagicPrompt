...
from wan.data.dataset_image_video import (ImageVideoDataset,
                                                ImageVideoSampler,
                                                get_random_mask)
from wan.models import (AutoencoderKLWan, AutoencoderKLWan3_8, WanT5EncoderModel,
                              Wan2_2Transformer3DModel)
from wan.pipeline import Wan2_2Pipeline, Wan2_2I2VPipeline
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default="low",
        help=(
            'The format of training data. Support `"low"`, `"high"` and `"full"`.'
        ),
    )
    parser.add_argument(
